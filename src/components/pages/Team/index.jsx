...
const testimonials = [
  {
    ...
    role: 'Group Member',
    content:
      'Actually there is nothing that stands out',
    avatar:
      'https://sctp-ce4-group1-react-flask.s3.ap-southeast-1.amazonaws.com/frog562.png',
  },
  {
    name: 'Lim Wei Yang',
    role: 'Group Member',
  ...
  {
    name: 'Chin Jinn Liong',
    role: 'Group Member',
    content:
      "Good project",
    avatar:
      'https://sctp-ce4-group1-react-flask.s3.ap-southeast-1.amazonaws.com/Picture1.PNG',
  },
  {
    name: 'Ng Han Rong',
    role: 'Group Member',
    content:
      'Ezpz. Up only',
    avatar:
      'https://sctp-ce4-group1-react-flask.s3.ap-southeast-1.amazonaws.com/hangy.jpg',
  },
]
...
function TestimonialCard({ name, role, content, avatar, index }) {
  ...
  // API to test to see if my logic works in the console
  ...
  useEffect(() => {
    fetch(`${process.env.REACT_APP_BACKEND_URL}/hello`)
      ...
      .then(data => {
        setData(data);
        console.log('Test data printed below:')
        console.log(data);
      })
    ...
    <Flex
      ...
      <Box width={{ base: 'full', sm: 'lg', lg: 'xl' }} margin={'auto'}>
        ...
        <chakra.h2
          ...
          See why our project stands out!
